...
if __name__ == '__main__':
    ...
    for l in lista:
        pasta = 'C:\\split_miner\\' + str(l)
        for diretorio, subpastas, arquivos in os.walk(pasta):
            for arquivo in arquivos:
                # print(os.path.join(diretorio, arquivo))
                if (l == '1'):
                    lista_log_event_1.append(os.path.join(diretorio, arquivo))
                elif (l == '2'):
                    lista_log_event_2.append(os.path.join(diretorio, arquivo))
                elif (l == '3'):
                    lista_log_event_3.append(os.path.join(diretorio, arquivo))
                elif (l == '4'):
                    lista_log_event_4.append(os.path.join(diretorio, arquivo))
                else:
                    lista_log_event_5.append(os.path.join(diretorio, arquivo))

    print(lista_log_event_5)

    for i in lista_log_event_5:
        print(i)
        net, initial_marking, final_marking = pmnl_importer.apply(i)
        check = check_easy_soundness_net_in_fin_marking(net, initial_marking, final_marking)
        print(check)
