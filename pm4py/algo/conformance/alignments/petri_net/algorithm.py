...
class Variants(Enum):
    ...
    VERSION_MY_DIJKSTRA = variants.my_dijkstra
...
VERSION_MY_DIJKSTRA = Variants.VERSION_MY_DIJKSTRA

VERSIONS = {Variants.VERSION_DIJKSTRA_NO_HEURISTICS, 
            Variants.VERSION_DIJKSTRA_NO_HEURISTICS,
            Variants.VERSION_DIJKSTRA_LESS_MEMORY,
            VERSION_DISCOUNTED_A_STAR,
            Variants.VERSION_MY_DIJKSTRA}
...
def apply_trace(trace, petri_net, initial_marking, final_marking, parameters=None,
    ...
    if type(trace_cost_function) is dict:
        trace_cost_function = variants.my_dijkstra.get_trace_cost_function(trace,
                                                                           parameters)
