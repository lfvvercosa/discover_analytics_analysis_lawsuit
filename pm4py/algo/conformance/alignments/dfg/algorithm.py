...
from pm4py.algo.conformance.alignments.dfg.variants import markov
from pm4py.algo.conformance.alignments.dfg.variants import test
from pm4py.algo.conformance.alignments.dfg.variants import test2
