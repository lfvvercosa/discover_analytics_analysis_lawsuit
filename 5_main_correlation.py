...
if __name__ == '__main__':
    ...
    df_pear_sorted = df_pear.sort_values(by=gt, key=abs, ascending=False)[[gt]]
    df_spear_sorted = df_spear.sort_values(by=gt, key=abs, ascending=False)[[gt]]
    ...
    df_pear_sorted = df_pear_sorted.rename(columns=map_names, index=map_names)
    df_spear_sorted = df_spear_sorted.rename(columns=map_names, index=map_names)

    print('### Pearson Correlation ###')
    print(df_pear_sorted)
    print()

    print('### Spearman Correlation ###')
    print(df_spear_sorted)
    print()