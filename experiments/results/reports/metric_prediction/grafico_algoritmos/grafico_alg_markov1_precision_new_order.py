...
y_svr = [43, 41, 46, 45, 45, 49, 49, 46, 50]
y_lr = [14, 33, 43, 29, 29, 50, 50, 27, 41]
y_MLP = [36, 32, 62, 44, 48, 49, 58, 42, 61]
y_RFR = [41, 30, 64, 53, 46, 60, 60, 49, 71]
y_XGB = [10, 34, 46, 19, 20, 58, 58, 21, 60]
