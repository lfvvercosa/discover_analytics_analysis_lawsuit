...
y_svr = [75, 63, 65, 70, 63, 75, 59, 70, 61]
y_lr = [57, 59, 55, 57, 59, 57, 52, 59, 55]
y_MLP = [67, 47, 65, 68, 58, 66, 63, 71, 59]
y_RFR = [84, 67, 85, 82, 67, 84, 86, 83, 85]
y_XGB = [81, 59, 82, 74, 59, 81, 76, 78, 80]
