...
if __name__ == '__main__':
    ...
    filename = 'variant_analysis/exp5/results/2step_2gram_dbs_crossf_log_2.txt'
    content = ""
    ...
    params_agglom['AWS_filename'] = \
        'variant_analysis/exp5/progress_exp5_2gram_dbs_crossf_2.txt'
    ...
    n_grams = [2]
    minimum_percents = [0.025]
    maximum_percents = [0.975]
