...
if __name__ == '__main__':
    ...
    filename = 'variant_analysis/exp4/results/1step_earth_move_crossf.txt'
    content = ""
    ...
    params_agglom['AWS_filename'] = 'variant_analysis/exp4/' + \
        'progress_exp4_1step_earth_mov_crossf.txt'
