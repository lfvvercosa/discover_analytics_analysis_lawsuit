...
def createMarkovAlign(ts, k_markov, ret_dict):
...
def calcMarkovTimeout(ts, k_markov, timeout):
...
if __name__ == '__main__':
    ...
    out_path = 'experiments/features_creation/feat_markov/' + \
               'feat_markov_align_bl_k_' + str(k_markov) + '.csv'
    comp_path = 'experiments/features_creation/feat_markov/' + \
               'feat_markov_align_bl_comp_k_' + str(k_markov) + '.csv'
    ...
    for fol in folders:
        ...
        for fil in my_files:
            for alg in algs:
                ...
                res = calcMarkovTimeout(ts, k_markov, timeout)
                ...
                graph_align = dfg_alignment.apply(log, 
                                    ...
                                    sa, 
                                    ea, 
                                    variant=dfg_alignment.Variants.CLASSIC,
                                    parameters={})
                graph_align_value = 0
