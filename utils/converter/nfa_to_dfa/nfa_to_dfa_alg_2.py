...
def get_final_states(states, init_state):
    final_states = []
    ...
    reachable = get_all_reachable_states({init_state}, None)
...
def convert_nfa_to_dfa_2(ts, 
    ...
    if not final_states:
        final_states = get_final_states(ts.states, init_state)
